 ...
 * @version 1.0.2
 */
public class HexIntegerStringConverter extends StringConverter<Integer> {
     ...
     */
    public HexIntegerStringConverter() { }
     ...
     */
    public HexIntegerStringConverter(Runnable reset) {
        _reset = reset;
    }
     ...
     */
    public HexIntegerStringConverter(TextField input, int min, int max) {
        if (input == null)
    ...
    /**
     * Creates an {@link HexIntegerStringConverter} for the specified {@link Spinner}.
     * Uses the {@link TextField} and minimum and maximum values of the specified
     * {@link Spinner} for construction, and also sets the new {@link HexIntegerStringConverter}
     * on its {@link SpinnerValueFactory.IntegerSpinnerValueFactory}.
     * 
     * @param spinner the {@link Spinner} to create an {@link HexIntegerStringConverter} for
     * @return the new {@link HexIntegerStringConverter}
     * @throws NullPointerException if {@code spinner} is {@code null}
     */
    public static HexIntegerStringConverter createFor(Spinner<Integer> spinner) {
        final SpinnerValueFactory.IntegerSpinnerValueFactory factory =
                (SpinnerValueFactory.IntegerSpinnerValueFactory) spinner.getValueFactory();

        final HexIntegerStringConverter converter = new HexIntegerStringConverter(
     ...
     * an {@link HexIntegerStringConverter} for a {@link TextField} or {@link Spinner},
